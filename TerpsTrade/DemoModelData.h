...
static NSString * const kJSQDemoAvatarDisplayNameSquires = @"Jack";
static NSString * const kJSQDemoAvatarDisplayNameCook = @"Jack";
static NSString * const kJSQDemoAvatarDisplayNameJobs = @"Jack";
static NSString * const kJSQDemoAvatarDisplayNameWoz = @"Jack";
